      ...
      <header className="sticky top-0 z-40 border-b border-[var(--c-divider)] bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-4">
            <Link href={`/analysis/${analysisId}`} className="inline-flex items-center gap-2 text-sm font-medium text-[var(--c-brand)]">
              <ArrowLeft size={16} />
              Back to analysis
            </Link>
            ...
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--c-text-faint)]">
                Consultant report mode
              </div>
              <div className="mt-1 text-sm text-[var(--c-text-muted)]">
                Board-ready rendering of the persisted ASIS strategic brief
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <ReportDownloadButton analysisId={analysisId} theme={theme} />
            <button
              type="button"
