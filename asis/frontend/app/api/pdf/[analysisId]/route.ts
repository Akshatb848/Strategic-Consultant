  ...
  try {
    ...
    const pdfBuffer = await page.pdf({
      ...
      footerTemplate: `
        <div style="width:100%;font-size:8pt;padding:0 18px;color:#718096;display:flex;justify-content:space-between;align-items:center;">
          ...
          <span>Generated by ASIS v4.0</span>
        </div>
      `,
    ...
    return new NextResponse(new Uint8Array(pdfBuffer), {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="ASIS_${brief.report_metadata.company_name.replace(/\s+/g, "_")}_${new Date(brief.report_metadata.generated_at).toISOString().slice(0, 10)}.pdf"`,
      },
    });
  } finally {
    await browser.close();
