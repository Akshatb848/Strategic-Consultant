...
class Settings(BaseModel):
    ...
    groq_model_fast: str = Field(default_factory=lambda: _env("GROQ_MODEL_FAST", "openai/gpt-oss-20b") or "openai/gpt-oss-20b")
    groq_model_reasoning: str = Field(default_factory=lambda: _env("GROQ_MODEL_REASONING", "openai/gpt-oss-120b") or "openai/gpt-oss-120b")
